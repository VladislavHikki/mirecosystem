<template>
  <div class="transaction">
    <h1 class="page-subtitle">Лимоны</h1>
    <pre>
      <!-- {{ financeStore }} -->
    </pre>
    <TabView>
    <TabPanel header="Рефералка">
      ...
      >
        ...
        <Column field="sender.name" header="Реферал"></Column>
        <Column field="recipient.account" header="Номер счета получателя"></Column>
        <Column field="recipient.name" header="Реферер"></Column>
        <Column field="amount" header="Выплата"></Column>
    ...
    <TabPanel header="Переводы"></TabPanel>
    <TabPanel header="Выводы"></TabPanel>
    <TabPanel header="Выпуски"></TabPanel>
    </TabView>
  </div>
</template>
